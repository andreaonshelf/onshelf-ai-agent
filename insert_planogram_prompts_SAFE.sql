-- Insert OnShelf AI Extraction Prompts using SAFE backward-compatible approach
-- This version works with BOTH prompt_content and prompt_text columns
...
-- (I'll truncate here for readability, but the pattern continues for all prompts)
